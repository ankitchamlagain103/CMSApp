...
{
    public class UpdateFestivalOccurrenceCommandValidator : AbstractValidator<UpdateFestivalOccurrenceCommand>
    {
        public UpdateFestivalOccurrenceCommandValidator()
        {
